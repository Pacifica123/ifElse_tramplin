import type { MapOptions, FitBoundsOptions, Padding, StyleState, SupportedSimpleOpts, WebGLContext, GraphicsPreset } from './types';
import type { MapEventTable } from './types/events';
import type { AnimationOptions, RotationAnimationOptions, ZoomAnimationOptions } from './types/animations';
import { Evented } from './utils/evented';
import type { LngLatBounds } from './objects/lngLatBounds';
import { LngLatBoundsClass } from './objects/lngLatBounds';
import type { Layer, StyleIconConfig, StyleOptions } from './types/styles';
...
export declare class Map extends Evented<MapEventTable> {
     ...
     * @param layerId The identifier of a layer or group.
     */
     ...
     * @param option Map option name. Only 'disableDragging', 'enableTrackResize', 'loopWorld', 'disableHidingPois',
     * or 'enableTwoFingerDragging' options are available.
    ...
    /**
     * Hides the layer or all layers in a group in the current map style and updates the active layers.
     * If only the id is specified, the corresponding layer or group will be hidden by id.
     * If only the type is specified, all layers with this type will be hidden.
     * If both the layer type and id are specified, layers will be hidden by type, and the id will be ignored.
     *
     * @param params.id Layer id to hide or group id to hide all its layers
     * @param params.type Type of layers to hide
     */
    hideLayers(params: {
        id?: string;
        type?: string;
    ...
    /**
     * Shows the layer or all layers in a group in the current map style and updates the active layers.
     * If only the id is specified, the corresponding layer or group will be shown.
     * If only the type is specified, all layers with this type will be shown.
     * If both the layer type and id are specified, layers will be shown by type, and the id will be ignored.
     *
     * @param params.id Layer id to show or group id to show all its layers
     * @param params.type Type of layers to show
     */
    showLayers(params: {
        id?: string;
        type?: string;
