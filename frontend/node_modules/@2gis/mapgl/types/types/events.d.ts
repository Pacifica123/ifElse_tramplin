...
import type { GeoJsonSource, RasterTileSource } from '../index';
import type { GraphicsPreset, GraphicsPresetName, TileCoords } from './index';
/**
...
export interface MapEventTable {
    ...
    /**
     * Emitted after some error happened.
     * Specific errors are differentiated by the `type` field.
     * @hidden
     */
    error: MapErrorEvent;
    /**
     ...
     * @hidden
     */
    graphicspresetchange: GraphicsPresetChangeEvent;
}
interface GraphicsPresetChangeEvent {
...
/**
 * Tile rester source load error event.
 * @hidden
 */
export interface RasterTileLoadErrorEvent {
    type: 'rasterTileLoadError';
 ...
 * @hidden
 */
export interface WebGLContextLostErrorEvent {
    type: 'webglcontextlost';
}
/**
 * @hidden
 */
interface StyleLoadError extends StyleLoadErrorEvent {
    type: 'styleloaderror';
}
/**
 * @hidden
 */
interface InvalidTileKeyErrorEvent {
    type: 'invalidtilekey';
}
/**
 * Tile source load error event.
 * @hidden
 */
export type MapErrorEvent = RasterTileLoadErrorEvent | WebGLContextLostErrorEvent | StyleLoadError | InvalidTileKeyErrorEvent;
export {};
