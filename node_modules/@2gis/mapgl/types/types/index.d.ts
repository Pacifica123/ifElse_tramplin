...
import type { AnimationOptions, Easing } from './animations';
import type { StyleOptions, Expression } from './styles';
import type { Feature, FeatureCollection } from 'geojson';
import type { RasterTileSource } from '../sources/rasterTileSource';
import type { GeoJsonSource } from '../sources/geoJsonSource';
...
export interface MapOptions {
    ...
    trafficOn?: boolean;
    /**
     * Forces map to use syncronous objects picking (identification).
     * This can cause performance issues on some devices, but can fix artifacts when sharing gl-context
     * between different libraries (e.g. deck.gl).
     */
    forceSyncIdentify?: boolean;
    /**
